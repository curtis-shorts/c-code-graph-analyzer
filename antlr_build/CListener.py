...
class CListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by CParser#macroName.
    def enterMacroName(self, ctx:CParser.MacroNameContext):
        pass

    # Exit a parse tree produced by CParser#macroName.
    def exitMacroName(self, ctx:CParser.MacroNameContext):
        pass


    # Enter a parse tree produced by CParser#macroBlockInvocation.
    def enterMacroBlockInvocation(self, ctx:CParser.MacroBlockInvocationContext):
        pass

    # Exit a parse tree produced by CParser#macroBlockInvocation.
    def exitMacroBlockInvocation(self, ctx:CParser.MacroBlockInvocationContext):
        pass


    # Enter a parse tree produced by CParser#macroReturnValue.
    def enterMacroReturnValue(self, ctx:CParser.MacroReturnValueContext):
        pass

    # Exit a parse tree produced by CParser#macroReturnValue.
    def exitMacroReturnValue(self, ctx:CParser.MacroReturnValueContext):
        pass


    # Enter a parse tree produced by CParser#macroInvocation.
    def enterMacroInvocation(self, ctx:CParser.MacroInvocationContext):
        pass

    # Exit a parse tree produced by CParser#macroInvocation.
    def exitMacroInvocation(self, ctx:CParser.MacroInvocationContext):
        pass
    ...
    # Enter a parse tree produced by CParser#genericOperator.
    def enterGenericOperator(self, ctx:CParser.GenericOperatorContext):
        pass

    # Exit a parse tree produced by CParser#genericOperator.
    def exitGenericOperator(self, ctx:CParser.GenericOperatorContext):
        pass
